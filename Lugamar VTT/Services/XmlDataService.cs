    ...
    public class XmlDataService
    {
        ...
        private static Character ParseCharacter(XElement sheet, int id)
        {
            ...
            var character = new Character
            {
                ...
                TempHitPoints = GetInt(charNode.Element("hp")?.Element("temporary")),
                Wounds = GetInt(charNode.Element("hp")?.Element("wounds")),
                NonLethalDamage = GetInt(charNode.Element("hp")?.Element("nonlethal")),
                DamageReduction = GetString(charNode.Element("defenses")?.Element("damagereduction")) ?? string.Empty,
                SpellResistance = GetInt(charNode.Element("defenses")?.Element("sr")?.Element("total")),
